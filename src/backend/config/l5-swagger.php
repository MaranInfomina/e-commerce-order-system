...
return [
    ...
    'documentations' => [
        'default' => [
            ...
            'routes' => [
                 ...
                 *
                 * Overridden from the published default (api/documentation)
                 * so the Swagger UI is served at /docs, per this project's
                 * OpenAPI documentation task. The raw generated spec (json)
                 * is served separately at defaults.routes.docs below
                 * ('api-docs') to avoid both routes claiming the same URI.
                 */
                'api' => 'docs',
            ],
            'paths' => [
    ...
    'defaults' => [
        'routes' => [
            /*
             * Route for accessing parsed swagger annotations (the raw
             * generated api-docs.json). Renamed from the published default
             * ('docs') to 'api-docs' because 'docs' above is now claimed by
             * the Swagger UI route itself — both routes sharing that URI
             * would let the UI route shadow this one and break the UI's own
             * fetch of the spec.
             */
            'docs' => 'api-docs',
